...
public class URLEncoder extends Object{
     ...
     * <li>The recommended encoding scheme to use is UTF-8. However, for compatibility reasons, if an encoding is not specified, then the default encoding of the platform is used.</li>
     * </ul>
     * <br>
     ...
     * <br><strong>Note: The World Wide Web Consortium Recommendation states that UTF-8 should be used. Not doing so may introduce incompatibilites.</strong>
     * @param s String to be translated.
